    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-info" id="title">ADICIONAR ORDEM DE SERVIÇO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form class="user" action="cad_ordem_envia.php" method="post" >
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class=text-right>
                            ...
                            <a title="Adicionar"><button type="submit" name="updatebtn" class="btn btn-info uptadebtn"><i class="fas fa-fw fa-clipboard-list">&nbsp;</i>Adicionar</button> </a>
                        </div>
                    </div>
                </form>  
            </div>

    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-info" id="title">ATUALIZAR DADOS DO CLIENTE</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="user" action="editar_cliente_envia.php" method="post">
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class=text-right>
                            <a title="Voltar" href="cliente.php"><button type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i>&nbsp;</i>Voltar</button></a>

    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold text-info" id="title">ATUALIZAR DADOS DO TERCEIRIZADO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="user" action="editar_terceirizado_envia.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label> Numero </label>
                            <input type="number" class="form-control form-control-user" id="numero" name="numero" value="<?= $numero ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label> Estado </label>
                            <input type="text" class="form-control form-control-user" id="estado" name="estado" value="<?= $estado ?>" readonly>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class=text-right>
                            <a title="Voltar" href="terceirizado.php"><button type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i>&nbsp;</i>Voltar</button></a>
